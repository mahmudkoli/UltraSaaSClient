...
@Component({
    ...
    standalone   : true,
    imports      : [FuseLoadingBarComponent, NgIf, FuseVerticalNavigationComponent, MatButtonModule, MatIconModule, FuseFullscreenComponent, UserComponent, TenantLogoComponent, FuseHorizontalNavigationComponent, RouterOutlet],
})
