...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'announcement-archive', loadChildren: () => import('app/modules/admin/announcement-archive/announcement-archive.routes')},
            {path: 'sms-templates', loadChildren: () => import('app/modules/admin/sms-templates/sms-templates.routes')},
            {path: 'mail-templates', loadChildren: () => import('app/modules/admin/mail-templates/mail-templates.routes')},
            {path: 'sms-logs', loadChildren: () => import('app/modules/admin/sms-logs/sms-logs.routes')},
            {path: 'mail-logs', loadChildren: () => import('app/modules/admin/mail-logs/mail-logs.routes')},
